...
ARG GITHUB_MIRROR=https://ghproxy.com/
ARG GOLANG_INJECT_TAG_VERSION=1.3.0
...
RUN mkdir -p /protobuf-c \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/protobuf-c/protobuf-c/tarball/v${PROTOBUF_C_VERSION} | tar xz --strip 1 -C /protobuf-c \
    && cd /protobuf-c \
...
RUN mkdir -p /grpc-java \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/grpc/grpc-java/tarball/v${GRPC_JAVA_VERSION} | tar xz --strip 1 -C /grpc-java \
    && cd /grpc-java \
...
RUN mkdir -p /grpc-web \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/grpc/grpc-web/tarball/${GRPC_WEB_VERSION} | tar xz --strip 1 -C /grpc-web \
    && cd /grpc-web \
    && make install-plugin \
...
ARG GOLANG_INJECT_TAG_VERSION
ENV GOPROXY https://goproxy.cn,https://mirrors.aliyun.com/goproxy,https://goproxy.io,direct
RUN go install github.com/favadi/protoc-go-inject-tag@v${GOLANG_INJECT_TAG_VERSION}

ARG PROTOC_GEN_DOC_VERSION
RUN mkdir -p ${GOPATH}/src/github.com/pseudomuto/protoc-gen-doc \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/pseudomuto/protoc-gen-doc/tarball/v${PROTOC_GEN_DOC_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/pseudomuto/protoc-gen-doc \
...
RUN mkdir -p ${GOPATH}/src/github.com/TheThingsIndustries/protoc-gen-fieldmask \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/TheThingsIndustries/protoc-gen-fieldmask/tarball/v${PROTOC_GEN_FIELDMASK_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/TheThingsIndustries/protoc-gen-fieldmask \
...
RUN mkdir -p ${GOPATH}/src/github.com/grpc/grpc-go \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/grpc/grpc-go/tarball/v${PROTOC_GEN_GO_GRPC_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/grpc/grpc-go \
...
RUN mkdir -p ${GOPATH}/src/github.com/golang/protobuf \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/golang/protobuf/tarball/v${PROTOC_GEN_GO_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/golang/protobuf \
...
RUN mkdir -p ${GOPATH}/src/github.com/gogo/protobuf \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/gogo/protobuf/tarball/v${PROTOC_GEN_GOGO_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/gogo/protobuf \
...
RUN mkdir -p ${GOPATH}/src/github.com/TheThingsIndustries/protoc-gen-gogottn \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/TheThingsIndustries/protoc-gen-gogottn/tarball/v${PROTOC_GEN_GOGOTTN_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/TheThingsIndustries/protoc-gen-gogottn \
...
RUN mkdir -p ${GOPATH}/src/github.com/mwitkow/go-proto-validators \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/mwitkow/go-proto-validators/tarball/v${PROTOC_GEN_GOVALIDATORS_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/mwitkow/go-proto-validators \
...
RUN mkdir -p ${GOPATH}/src/github.com/danielvladco/go-proto-gql \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/danielvladco/go-proto-gql/tarball/v${PROTOC_GEN_GQL_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/danielvladco/go-proto-gql \
...
RUN mkdir -p ${GOPATH}/src/github.com/envoyproxy/protoc-gen-validate \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/envoyproxy/protoc-gen-validate/tarball/v${PROTOC_GEN_VALIDATE_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/envoyproxy/protoc-gen-validate \
...
RUN mkdir -p ${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/grpc-ecosystem/grpc-gateway/tarball/v${GRPC_GATEWAY_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway \
...
RUN mkdir -p ${GOPATH}/src/github.com/googleapis/googleapis \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/googleapis/googleapis/tarball/${GOOGLE_API_VERSION} | tar xz --strip 1 -C ${GOPATH}/src/github.com/googleapis/googleapis \
...
RUN mkdir -p /rust-protobuf \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/stepancheg/rust-protobuf/tarball/v${RUST_PROTOBUF_VERSION} | tar xz --strip 1 -C /rust-protobuf \
...
RUN mkdir -p /grpc-rust \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/stepancheg/grpc-rust/tarball/v${GRPC_RUST_VERSION} | tar xz --strip 1 -C /grpc-rust \
...
RUN mkdir -p /grpc-swift \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/grpc/grpc-swift/tarball/${GRPC_SWIFT_VERSION} | tar xz --strip 1 -C /grpc-swift \
...
RUN mkdir -p /dart-protobuf \
    && curl -sSL ${GITHUB_MIRROR}https://api.github.com/repos/google/protobuf.dart/tarball/protobuf-v${DART_PROTOBUF_VERSION} | tar xz --strip 1 -C /dart-protobuf \
...
RUN apk add --no-cache curl \
    && mkdir -p /upx \
    && curl -sSL ${GITHUB_MIRROR}https://github.com/upx/upx/releases/download/v${UPX_VERSION}/upx-${UPX_VERSION}-amd64_linux.tar.xz | tar xJ --strip 1 -C /upx \
...
LABEL architecture="AMD64/x86_64" version="latest" build="2021-11-08"
LABEL Description="Drone持续集成Protobuf插件，集成所有常见的Protobuf语言工具以及常用的插件"


# 复制文件
COPY --from=packer /out/ /
COPY --from=golang /go/bin/protoc-go-inject-tag /usr/bin/gotag
COPY protobuf /bin
...
RUN set -ex \
    ...
    && wget ${GITHUB_MIRROR}https://github.com/sgerrand/alpine-pkg-glibc/releases/download/2.31-r0/glibc-2.31-r0.apk \
